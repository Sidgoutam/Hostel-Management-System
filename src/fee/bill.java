...
public class bill {
 ...
 private final   StringProperty month;
   ...
   public bill (int id,int reg,String name,String hostel,String room,String month, String year,float totalunit,float unitrate, float amount, float fine,int total,String date)
   {
