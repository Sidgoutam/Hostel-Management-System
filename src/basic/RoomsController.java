...
Parent s1 = FXMLLoader.load(getClass().getResource("/basic/shift.fxml"));
      ...
      @FXML
    void newhostel(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/addhostel/add_new_hostel.fxml"));
      ...
      @FXML
    void newroom(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/addrooms/addnewrooms.fxml"));
        Scene s1scene = new Scene(s1);
     ...
     @FXML
    void delhostel(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/delete/deletehostel.fxml"));
        Scene s1scene = new Scene(s1);
     ...
     @FXML
    void delroom(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/delete/deleteroom.fxml"));
        Scene s1scene = new Scene(s1);
