...
Parent s1 = FXMLLoader.load(getClass().getResource("/basic/shift.fxml"));
    ...
    @FXML
    void addhostelrent(ActionEvent event) throws IOException {
   Parent s1 = FXMLLoader.load(getClass().getResource("/roomrent/addrenthostel.fxml"));
        Scene s1scene = new Scene(s1);
    ...
    @FXML
    void addsturent(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/roomrent/addroomrent.fxml"));
        Scene s1scene = new Scene(s1);
 ...
 @FXML
    void paidrent(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/roomrent/paidroomrent.fxml"));
        Scene s1scene = new Scene(s1);
...
Parent s1 = FXMLLoader.load(getClass().getResource("/roomrent/payrent.fxml"));
        Scene s1scene = new Scene(s1);
    ...
    @FXML
    void pendingrent(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/roomrent/pendingroomrent.fxml"));
        Scene s1scene = new Scene(s1);
...
Parent s1 = FXMLLoader.load(getClass().getResource("/rules/rule.fxml"));
    ...
    @FXML
    private void showstatus(ActionEvent event) throws IOException {
        Parent s1 = FXMLLoader.load(getClass().getResource("/roomrent/rentstatus.fxml"));
        Scene s1scene = new Scene(s1);
