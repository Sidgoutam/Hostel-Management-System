...
Parent s1 = FXMLLoader.load(getClass().getResource("/resetpassword/sidemain.fxml"));
 ...
 @FXML
    void showstatus(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/fee/feestatus.fxml"));
        Scene s1scene = new Scene(s1);
...
Parent s1 = FXMLLoader.load(getClass().getResource("/basic/student.fxml"));
     ...
     @FXML
    void pendingbill(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/fee/showpendingbill.fxml"));
     ...
     @FXML
    void completebill(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/fee/showsubmitbill.fxml"));
     ...
     @FXML
    void submitbill(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/fee/submitfees.fxml"));
        Scene s1scene = new Scene(s1);
     ...
     @FXML
    void addnewbill(ActionEvent event) throws IOException {
