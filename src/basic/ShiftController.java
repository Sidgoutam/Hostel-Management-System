...
@FXML
    void emptyroom(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/changeroom/shift_to_empty room.fxml"));
    ...
    @FXML
    void anotherhostel(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/changeroom/shift_to_another_hostel.fxml"));
    ...
    @FXML
    void swaproom(ActionEvent event) throws IOException {
