...
Parent s1 = FXMLLoader.load(getClass().getResource("/basic/shift.fxml"));
    ...
    @FXML
    void addhostelmess(ActionEvent event) throws IOException {
   Parent s1 = FXMLLoader.load(getClass().getResource("/Messbill/addmesshostel.fxml"));
        Scene s1scene = new Scene(s1);
    ...
    @FXML
    void addstumess(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/Messbill/addmess.fxml"));
        Scene s1scene = new Scene(s1);
 ...
 @FXML
    void paidmess(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/Messbill/paidmess.fxml"));
        Scene s1scene = new Scene(s1);
    ...
    @FXML
    void paymess(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/Messbill/paymess.fxml"));
    ...
    @FXML
    void pendingmess(ActionEvent event) throws IOException {
Parent s1 = FXMLLoader.load(getClass().getResource("/Messbill/pendingmess.fxml"));
        Scene s1scene = new Scene(s1);
