 ...
 * @author govind
 */
public class PaidroomrentController implements Initializable {
...
else
{
  ...
  doc.add(para2);
  Paragraph para3 = new Paragraph("ROOM RENT Paid \n\n",f3);
...
//To change body of generated methods, choose Tools | Templates.
  ...
  data.clear();
  SearchField.clear();
  ResultSet rs = conn.createStatement().executeQuery("SELECT * FROM `comperent`");
  int start =1;
  while (rs.next())
  {
